...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  Future<void> checkVerificationStatus() async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://baobab-vision-project-peox.onrender.com/api/auth/check-verification-token'),
    ...
    try {
      ...
      if (response.statusCode == 200 && data['verified'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Your verification link expired. Kindly resend.')),
        );
  ...
  Future<void> resendVerificationEmail() async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://baobab-vision-project-peox.onrender.com/api/auth/resend-verification'),
      headers: {'Content-Type': 'application/json'},
                      ...
                      : SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor:
                                  const Color.fromARGB(255, 32, 150, 69),
