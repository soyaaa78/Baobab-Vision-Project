...
function EditEyeglassPage() {
  return (
    <>
      <div className="edit-eyeglass-container">
          ...
          <div className="edit-eyeglass-bulk">
            ...
            <div className="ee-details-section">
              ...
              <div className="ee-details-body-text">
                <p>
                  MIRANDA is best worn while strolling a lavish mansion,
                  wondering how you can contact the real estate agent. <br />
                  <br />
                  ...
                  <br />
                  - Impact resistant and saltwater-proof <br />- Perfect for men
                  and women with round, heart, diamond, and oval face shapes who
                  want maximum sun coverage in style
                </p>
              </div>
              ...
              <div className="ee-details-color-selection">
                <div className="color-text">
                  <p>
                    color: placeholder{" "}
                    {/* change placeholder to be changable */}
                  </p>
                </div>
