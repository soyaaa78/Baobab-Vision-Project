...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final Map<String, Map<String, Map<String, List<String>>>> philippinesRegions = {
    'NCR': {
      'Metro Manila': {
        ...
        'Las Pinas City':['Almanza Dos', 'Almanza Uno', 'B. F. International Village', 'Daniel Fajardo', 'Elias Aldana', 'Ilaya', 'Manuyo Dos', 'Manuyo Uno', 'Pamplona Dos', 'Pamplona Tres', 'Pamplona Uno', 'Pilar', 'Pulang Lupa Dos','Pulang Lupa Uno','Talon Dos','Talon Kuatro','Talon Singko','Talon Tres','Talon Uno','Zapote'],
        'Makati City':['Bangkal','Bel-air','Carmona','Cembo','Comembo','Dasmarinas','East Rembo','Forber Park','Guadaluper Nuervo','Guadalupe Viejo','Kasilawan','La Paz','Magallanes','Olympia','Palanan','Pembo','Pinagkaisahan','Pio Del Pilar','Pitogo','Poblacion','Post Proper Northside','Post Proper Southside','Rizal','San Antonio','San Isidro','San Lorenzo','Santa Cruz','Singkamas','South Cembo','Tejeros', 'Urdaneta','Valenzuela','West Rembo'],
        'Malabon City':['Acacia','Baritan','Bayan-Bayanan','Catmon','Conception','Dampalit','Flores','Halong Duhat','Ibaba','Longos','Maysilo','Muzon','Niugan','Panghulo','Potrero','San Agustin','Santolan','Tanong','Tinajeros','Tonsuya','Tugatog'],
        ...
        'Mandaluyong City':['Addition Hills','Bagong Silang','Barangka Drive','Barangka Ibaba','Barangka Ilaya','Barangka Itaas','Barangka Bato','Burol','Daang Bakal','Hagdang Bato Itaas','Hagdang Bato Libis', 'Harapin Ang Bukas','Highway Hills','Hulo','Mabini-J Rizal','Malamig','Mauway','Namayan','New Zaniga',' Old Zaniga','Pag-asa','Plainview','Pleasant Hills','Poblacion',' San Jose',' Vergara','Wack-Wack Greenhills'],
        'Marikina City':['Barangka','Calumpang','Conception Dos','Conception Uno','Fortune','Industrial Valley','Jesus De La Pena','Malanday','Marikina Heights (Conception)','Nangka','Parang','San Roque','Santa Elena','Santo Nino','Tanong','Tumana'],
        'Muntinlupa City':['Alabang','Ayala Alabang','Bayanan','Buli','Cupang','Poblacion','Putatan','Sucat','Tunasan'],
        'Navotas City':['Bagumbayan North','Bagumbayan South','Bangculasi','Daanghari','Navotas East','Navotas West','North Bay Blvd.','San Jose','San Rafael Village','San Roque','Sipac-Almacen','Tangos','Tanza'],
        'Paco':['Barangay 662', 'Barangay 664-A','Barangay 671','Barangay 672','Barangay 673','Barangay 674','Barangay 675','Barangay 676','Barangay 677','Barangay 678','Barangay 679','Barangay 680','Barangay 681','Barangay 682','Barangay 683','Barangay 684','Barangay 685','Barangay 686',' Barangay 687','Barangay 688','Barangay 689','Barangay 690']
        },
    },
    'Region 1': {
      'Ilocos Norte': {
  ...
  void _handleSubmit() {
    if (selectedDeliveryMethod == 'Lalamove') {
      ...
      // TODO: Save order with delivery info to backend/admin panel
    } else {
  if (selectedPaymentMethod == 'Pay Cash') {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Please pay the exact total amount of cash upon pickup.'),
          actions: [
            TextButton(
              onPressed: () {
    ...
    // TODO: Save order info with Pay Cash and Pick Up
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: selectedDeliveryMethod == 'Pick Up' ? Colors.black : Colors.white,
                        borderRadius: BorderRadius.circular(15),
                        border: Border.all(
                          color: selectedDeliveryMethod == 'Pick Up' ? Colors.black : Colors.grey.shade300,
                          width: 2,
                        ),
                      ),
                      child: Center(
                        child: CustomText(
                          ...
                          fontWeight: FontWeight.bold,
                          color: selectedDeliveryMethod == 'Pick Up' ? Colors.white : Colors.black,
                        ),
                      ),
                    ),
                  ),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      padding: EdgeInsets.all(15.sp),
                      decoration: BoxDecoration(
                        color: selectedDeliveryMethod == 'Lalamove' ? Colors.black : Colors.white,
                        borderRadius: BorderRadius.circular(15),
                        border: Border.all(
                          color: selectedDeliveryMethod == 'Lalamove' ? Colors.black : Colors.grey.shade300,
                          width: 2,
                        ),
                      ),
                      child: Center(
                        child: CustomText(
                          ...
                          fontWeight: FontWeight.bold,
                          color: selectedDeliveryMethod == 'Lalamove' ? Colors.white : Colors.black,
                        ),
                      ),
                    ),
                  ),
            ...
            if (selectedDeliveryMethod == 'Pick Up') ...[
              ...
              GestureDetector(
                ...
                child: Container(
                  padding: EdgeInsets.all(15.sp),
                  decoration: BoxDecoration(
                    color: selectedPaymentMethod == 'Pay Cash' ? Colors.black : Colors.white,
                    borderRadius: BorderRadius.circular(15),
                    border: Border.all(
                      color: selectedPaymentMethod == 'Pay Cash' ? Colors.black : Colors.grey.shade300,
                      width: 2,
                    ),
                    boxShadow: [
                      if (selectedPaymentMethod == 'Pay Cash')
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.monetization_on_outlined, size: 40.sp, color: selectedPaymentMethod == 'Pay Cash' ? Colors.white : Colors.black),
                      SizedBox(width: 15.w),
                      Expanded(
                        child: CustomText(
                          ...
                          fontWeight: FontWeight.bold,
                          color: selectedPaymentMethod == 'Pay Cash' ? Colors.white : Colors.black,
                          maxLines: 1,
                        ),
                      ),
                      if (selectedPaymentMethod == 'Pay Cash')
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        cities = (selectedRegion != null && value != null)
                            ? philippinesRegions[selectedRegion]![value]!.keys.toList()
                            : [];
                        barangays = [];
                      });
                    },
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        barangays = (selectedRegion != null &&
                                selectedProvince != null &&
                                value != null)
                            ? philippinesRegions[selectedRegion]![selectedProvince]![value]!
                            : [];
                      });
                    },
                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 15.h),
                      CustomText(
                        text: 'Thank you! Our staff will contact you at your number for the process of third-party delivery.',
                        fontSize: ScreenUtil().setSp(18),
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
